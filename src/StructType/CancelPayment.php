...
/**
 * This class stands for cancelPayment StructType
 * Meta informations extracted from the WSDL
 * - type: tns:cancelPayment
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CancelPayment extends AbstractStructBase
{
    /**
     * The commonRequest
     * Meta informations extracted from the WSDL
    ...
    public $queryRequest;
    /**
     * Constructor method for cancelPayment
     * @uses CancelPayment::setCommonRequest()
     * @uses CancelPayment::setQueryRequest()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonRequest $commonRequest
     * @return \Restoore\SystempayWebservice\StructType\CancelPayment
     */

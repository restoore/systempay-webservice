...
/**
 * This class stands for cancelPaymentResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CancelPaymentResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for cancelPaymentResult
     * @uses CancelPaymentResult::setCommonResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\CancelPaymentResult
     */

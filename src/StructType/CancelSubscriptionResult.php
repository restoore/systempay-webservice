...
/**
 * This class stands for cancelSubscriptionResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CancelSubscriptionResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for cancelSubscriptionResult
     * @uses CancelSubscriptionResult::setCommonResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\CancelSubscriptionResult
     */

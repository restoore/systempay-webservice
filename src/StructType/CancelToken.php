...
/**
 * This class stands for cancelToken StructType
 * Meta informations extracted from the WSDL
 * - type: tns:cancelToken
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CancelToken extends AbstractStructBase
{
    /**
     * The commonRequest
     * Meta informations extracted from the WSDL
    ...
    public $queryRequest;
    /**
     * Constructor method for cancelToken
     * @uses CancelToken::setCommonRequest()
     * @uses CancelToken::setQueryRequest()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonRequest $commonRequest
     * @return \Restoore\SystempayWebservice\StructType\CancelToken
     */

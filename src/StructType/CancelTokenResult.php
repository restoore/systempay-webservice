...
/**
 * This class stands for cancelTokenResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CancelTokenResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for cancelTokenResult
     * @uses CancelTokenResult::setCommonResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\CancelTokenResult
     */

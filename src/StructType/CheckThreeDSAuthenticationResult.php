...
/**
 * This class stands for checkThreeDSAuthenticationResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CheckThreeDSAuthenticationResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for checkThreeDSAuthenticationResult
     * @uses CheckThreeDSAuthenticationResult::setCommonResponse()
     * @uses CheckThreeDSAuthenticationResult::setThreeDSResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\CheckThreeDSAuthenticationResult
     */

...
/**
 * This class stands for createSubscriptionResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CreateSubscriptionResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for createSubscriptionResult
     * @uses CreateSubscriptionResult::setCommonResponse()
     * @uses CreateSubscriptionResult::setPaymentResponse()
     * @uses CreateSubscriptionResult::setOrderResponse()
     * @uses CreateSubscriptionResult::setCardResponse()
     * @uses CreateSubscriptionResult::setAuthorizationResponse()
     * @uses CreateSubscriptionResult::setCaptureResponse()
     * @uses CreateSubscriptionResult::setCustomerResponse()
     * @uses CreateSubscriptionResult::setMarkResponse()
     * @uses CreateSubscriptionResult::setThreeDSResponse()
     * @uses CreateSubscriptionResult::setExtraResponse()
     * @uses CreateSubscriptionResult::setSubscriptionResponse()
     * @uses CreateSubscriptionResult::setFraudManagementResponse()
     * @uses CreateSubscriptionResult::setShoppingCartResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\CreateSubscriptionResult
     */

...
/**
 * This class stands for createTokenFromTransactionResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CreateTokenFromTransactionResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for createTokenFromTransactionResult
     * @uses CreateTokenFromTransactionResult::setCommonResponse()
     * @uses CreateTokenFromTransactionResult::setPaymentResponse()
     * @uses CreateTokenFromTransactionResult::setOrderResponse()
     * @uses CreateTokenFromTransactionResult::setCardResponse()
     * @uses CreateTokenFromTransactionResult::setAuthorizationResponse()
     * @uses CreateTokenFromTransactionResult::setCaptureResponse()
     * @uses CreateTokenFromTransactionResult::setCustomerResponse()
     * @uses CreateTokenFromTransactionResult::setMarkResponse()
     * @uses CreateTokenFromTransactionResult::setThreeDSResponse()
     * @uses CreateTokenFromTransactionResult::setExtraResponse()
     * @uses CreateTokenFromTransactionResult::setSubscriptionResponse()
     * @uses CreateTokenFromTransactionResult::setFraudManagementResponse()
     * @uses CreateTokenFromTransactionResult::setShoppingCartResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\CreateTokenFromTransactionResult
     */

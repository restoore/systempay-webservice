...
/**
 * This class stands for createTokenResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class CreateTokenResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for createTokenResult
     * @uses CreateTokenResult::setCommonResponse()
     * @uses CreateTokenResult::setPaymentResponse()
     * @uses CreateTokenResult::setOrderResponse()
     * @uses CreateTokenResult::setCardResponse()
     * @uses CreateTokenResult::setAuthorizationResponse()
     * @uses CreateTokenResult::setCaptureResponse()
     * @uses CreateTokenResult::setCustomerResponse()
     * @uses CreateTokenResult::setMarkResponse()
     * @uses CreateTokenResult::setThreeDSResponse()
     * @uses CreateTokenResult::setExtraResponse()
     * @uses CreateTokenResult::setSubscriptionResponse()
     * @uses CreateTokenResult::setFraudManagementResponse()
     * @uses CreateTokenResult::setShoppingCartResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\CreateTokenResult
     */

...
/**
 * This class stands for duplicatePaymentResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class DuplicatePaymentResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for duplicatePaymentResult
     * @uses DuplicatePaymentResult::setCommonResponse()
     * @uses DuplicatePaymentResult::setPaymentResponse()
     * @uses DuplicatePaymentResult::setOrderResponse()
     * @uses DuplicatePaymentResult::setCardResponse()
     * @uses DuplicatePaymentResult::setAuthorizationResponse()
     * @uses DuplicatePaymentResult::setCaptureResponse()
     * @uses DuplicatePaymentResult::setCustomerResponse()
     * @uses DuplicatePaymentResult::setMarkResponse()
     * @uses DuplicatePaymentResult::setThreeDSResponse()
     * @uses DuplicatePaymentResult::setExtraResponse()
     * @uses DuplicatePaymentResult::setFraudManagementResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\DuplicatePaymentResult
     */

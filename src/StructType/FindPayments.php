...
/**
 * This class stands for findPayments StructType
 * Meta informations extracted from the WSDL
 * - type: tns:findPayments
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class FindPayments extends AbstractStructBase
{
    /**
     * The queryRequest
     * Meta informations extracted from the WSDL
    ...
    public $queryRequest;
    /**
     * Constructor method for findPayments
     * @uses FindPayments::setQueryRequest()
     ...
     * @param \Restoore\SystempayWebservice\StructType\QueryRequest $queryRequest
     * @return \Restoore\SystempayWebservice\StructType\FindPayments
     */

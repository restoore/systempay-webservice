...
/**
 * This class stands for getPaymentDetails StructType
 * Meta informations extracted from the WSDL
 * - type: tns:getPaymentDetails
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class GetPaymentDetails extends AbstractStructBase
{
    /**
     * The queryRequest
     * Meta informations extracted from the WSDL
    ...
    public $queryRequest;
    /**
     * Constructor method for getPaymentDetails
     * @uses GetPaymentDetails::setQueryRequest()
     ...
     * @param \Restoore\SystempayWebservice\StructType\QueryRequest $queryRequest
     * @return \Restoore\SystempayWebservice\StructType\GetPaymentDetails
     */

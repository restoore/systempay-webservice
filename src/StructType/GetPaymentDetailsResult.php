...
/**
 * This class stands for getPaymentDetailsResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class GetPaymentDetailsResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for getPaymentDetailsResult
     * @uses GetPaymentDetailsResult::setCommonResponse()
     * @uses GetPaymentDetailsResult::setPaymentResponse()
     * @uses GetPaymentDetailsResult::setOrderResponse()
     * @uses GetPaymentDetailsResult::setCardResponse()
     * @uses GetPaymentDetailsResult::setAuthorizationResponse()
     * @uses GetPaymentDetailsResult::setCaptureResponse()
     * @uses GetPaymentDetailsResult::setCustomerResponse()
     * @uses GetPaymentDetailsResult::setMarkResponse()
     * @uses GetPaymentDetailsResult::setSubscriptionResponse()
     * @uses GetPaymentDetailsResult::setExtraResponse()
     * @uses GetPaymentDetailsResult::setFraudManagementResponse()
     * @uses GetPaymentDetailsResult::setThreeDSResponse()
     * @uses GetPaymentDetailsResult::setTokenResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\GetPaymentDetailsResult
     */

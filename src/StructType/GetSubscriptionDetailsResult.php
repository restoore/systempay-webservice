...
/**
 * This class stands for getSubscriptionDetailsResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class GetSubscriptionDetailsResult extends WsResponse
{
    /**
     * The commonResponse
     ...
     * Meta informations extracted from the WSDL
     * - minOccurs: 0
     * @var \Restoore\SystempayWebservice\StructType\TokenResponse
     */
    public $tokenResponse;
    /**
     * Constructor method for getSubscriptionDetailsResult
     * @uses GetSubscriptionDetailsResult::setCommonResponse()
     * @uses GetSubscriptionDetailsResult::setPaymentResponse()
     * @uses GetSubscriptionDetailsResult::setOrderResponse()
     * @uses GetSubscriptionDetailsResult::setCardResponse()
     * @uses GetSubscriptionDetailsResult::setAuthorizationResponse()
     * @uses GetSubscriptionDetailsResult::setCaptureResponse()
     * @uses GetSubscriptionDetailsResult::setCustomerResponse()
     * @uses GetSubscriptionDetailsResult::setMarkResponse()
     * @uses GetSubscriptionDetailsResult::setSubscriptionResponse()
     * @uses GetSubscriptionDetailsResult::setExtraResponse()
     * @uses GetSubscriptionDetailsResult::setFraudManagementResponse()
     * @uses GetSubscriptionDetailsResult::setThreeDSResponse()
     * @uses GetSubscriptionDetailsResult::setTokenResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\GetSubscriptionDetailsResult
     */
    ...
    /**
     * Get tokenResponse value
     * @return \Restoore\SystempayWebservice\StructType\TokenResponse|null
     */
     ...
     * @return \Restoore\SystempayWebservice\StructType\GetSubscriptionDetailsResult
     */
    public function setTokenResponse(\Restoore\SystempayWebservice\StructType\TokenResponse $tokenResponse = null)
    {

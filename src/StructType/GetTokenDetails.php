...
/**
 * This class stands for getTokenDetails StructType
 * Meta informations extracted from the WSDL
 * - type: tns:getTokenDetails
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class GetTokenDetails extends AbstractStructBase
{
    /**
     * The queryRequest
     * Meta informations extracted from the WSDL
    ...
    public $queryRequest;
    /**
     * Constructor method for getTokenDetails
     * @uses GetTokenDetails::setQueryRequest()
     ...
     * @param \Restoore\SystempayWebservice\StructType\QueryRequest $queryRequest
     * @return \Restoore\SystempayWebservice\StructType\GetTokenDetails
     */

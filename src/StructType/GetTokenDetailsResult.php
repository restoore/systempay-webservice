...
/**
 * This class stands for getTokenDetailsResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class GetTokenDetailsResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for getTokenDetailsResult
     * @uses GetTokenDetailsResult::setCommonResponse()
     * @uses GetTokenDetailsResult::setPaymentResponse()
     * @uses GetTokenDetailsResult::setOrderResponse()
     * @uses GetTokenDetailsResult::setCardResponse()
     * @uses GetTokenDetailsResult::setAuthorizationResponse()
     * @uses GetTokenDetailsResult::setCaptureResponse()
     * @uses GetTokenDetailsResult::setCustomerResponse()
     * @uses GetTokenDetailsResult::setMarkResponse()
     * @uses GetTokenDetailsResult::setSubscriptionResponse()
     * @uses GetTokenDetailsResult::setExtraResponse()
     * @uses GetTokenDetailsResult::setFraudManagementResponse()
     * @uses GetTokenDetailsResult::setThreeDSResponse()
     * @uses GetTokenDetailsResult::setTokenResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\GetTokenDetailsResult
     */

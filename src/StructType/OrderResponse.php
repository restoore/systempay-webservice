...
class OrderResponse extends AbstractStructBase
{
     ...
     * Set orderId value
     * @param string $orderId
     * @return \Restoore\SystempayWebservice\StructType\OrderResponse
     */
    ...
    {
        foreach ($extInfo as $orderResponseExtInfoItem) {
            // validation for constraint: itemType
            if (!$orderResponseExtInfoItem instanceof \Restoore\SystempayWebservice\StructType\ExtInfo) {
                throw new \InvalidArgumentException(sprintf('The extInfo property can only contain items of \Restoore\SystempayWebservice\StructType\ExtInfo, "%s" given', is_object($orderResponseExtInfoItem) ? get_class($orderResponseExtInfoItem) : gettype($orderResponseExtInfoItem)), __LINE__);
            }
        }

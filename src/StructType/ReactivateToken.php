...
/**
 * This class stands for reactivateToken StructType
 * Meta informations extracted from the WSDL
 * - type: tns:reactivateToken
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class ReactivateToken extends AbstractStructBase
{
    /**
     * The queryRequest
     * Meta informations extracted from the WSDL
    ...
    public $queryRequest;
    /**
     * Constructor method for reactivateToken
     * @uses ReactivateToken::setQueryRequest()
     ...
     * @param \Restoore\SystempayWebservice\StructType\QueryRequest $queryRequest
     * @return \Restoore\SystempayWebservice\StructType\ReactivateToken
     */

...
/**
 * This class stands for reactivateTokenResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class ReactivateTokenResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for reactivateTokenResult
     * @uses ReactivateTokenResult::setCommonResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\ReactivateTokenResult
     */

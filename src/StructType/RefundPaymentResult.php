...
/**
 * This class stands for refundPaymentResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class RefundPaymentResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for refundPaymentResult
     * @uses RefundPaymentResult::setCommonResponse()
     * @uses RefundPaymentResult::setPaymentResponse()
     * @uses RefundPaymentResult::setOrderResponse()
     * @uses RefundPaymentResult::setCardResponse()
     * @uses RefundPaymentResult::setAuthorizationResponse()
     * @uses RefundPaymentResult::setCaptureResponse()
     * @uses RefundPaymentResult::setCustomerResponse()
     * @uses RefundPaymentResult::setMarkResponse()
     * @uses RefundPaymentResult::setThreeDSResponse()
     * @uses RefundPaymentResult::setExtraResponse()
     * @uses RefundPaymentResult::setFraudManagementResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\RefundPaymentResult
     */

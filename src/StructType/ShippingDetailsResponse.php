...
/**
 * This class stands for shippingDetailsResponse StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class ShippingDetailsResponse extends AbstractStructBase
{
    /**
     * The type
    ...
    public $identityCode;
    /**
     * Constructor method for shippingDetailsResponse
     * @uses ShippingDetailsResponse::setType()
     * @uses ShippingDetailsResponse::setFirstName()
     * @uses ShippingDetailsResponse::setLastName()
     * @uses ShippingDetailsResponse::setPhoneNumber()
     * @uses ShippingDetailsResponse::setStreetNumber()
     * @uses ShippingDetailsResponse::setAddress()
     * @uses ShippingDetailsResponse::setAddress2()
     * @uses ShippingDetailsResponse::setDistrict()
     * @uses ShippingDetailsResponse::setZipCode()
     * @uses ShippingDetailsResponse::setCity()
     * @uses ShippingDetailsResponse::setState()
     * @uses ShippingDetailsResponse::setCountry()
     * @uses ShippingDetailsResponse::setDeliveryCompanyName()
     * @uses ShippingDetailsResponse::setShippingSpeed()
     * @uses ShippingDetailsResponse::setShippingMethod()
     * @uses ShippingDetailsResponse::setLegalName()
     * @uses ShippingDetailsResponse::setIdentityCode()
     * @param string $type
     ...
     * @param string $type
     * @return \Restoore\SystempayWebservice\StructType\ShippingDetailsResponse
     */

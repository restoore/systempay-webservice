...
/**
 * This class stands for updatePaymentDetailsResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class UpdatePaymentDetailsResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for updatePaymentDetailsResult
     * @uses UpdatePaymentDetailsResult::setCommonResponse()
     * @uses UpdatePaymentDetailsResult::setPaymentResponse()
     * @uses UpdatePaymentDetailsResult::setOrderResponse()
     * @uses UpdatePaymentDetailsResult::setCardResponse()
     * @uses UpdatePaymentDetailsResult::setAuthorizationResponse()
     * @uses UpdatePaymentDetailsResult::setCaptureResponse()
     * @uses UpdatePaymentDetailsResult::setCustomerResponse()
     * @uses UpdatePaymentDetailsResult::setMarkResponse()
     * @uses UpdatePaymentDetailsResult::setThreeDSResponse()
     * @uses UpdatePaymentDetailsResult::setExtraResponse()
     * @uses UpdatePaymentDetailsResult::setSubscriptionResponse()
     * @uses UpdatePaymentDetailsResult::setFraudManagementResponse()
     * @uses UpdatePaymentDetailsResult::setShoppingCartResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\UpdatePaymentDetailsResult
     */

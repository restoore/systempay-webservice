...
/**
 * This class stands for updatePaymentResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class UpdatePaymentResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for updatePaymentResult
     * @uses UpdatePaymentResult::setCommonResponse()
     * @uses UpdatePaymentResult::setPaymentResponse()
     * @uses UpdatePaymentResult::setOrderResponse()
     * @uses UpdatePaymentResult::setCardResponse()
     * @uses UpdatePaymentResult::setAuthorizationResponse()
     * @uses UpdatePaymentResult::setCaptureResponse()
     * @uses UpdatePaymentResult::setCustomerResponse()
     * @uses UpdatePaymentResult::setMarkResponse()
     * @uses UpdatePaymentResult::setThreeDSResponse()
     * @uses UpdatePaymentResult::setExtraResponse()
     * @uses UpdatePaymentResult::setSubscriptionResponse()
     * @uses UpdatePaymentResult::setFraudManagementResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\UpdatePaymentResult
     */

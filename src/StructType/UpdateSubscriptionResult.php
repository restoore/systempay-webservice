...
/**
 * This class stands for updateSubscriptionResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class UpdateSubscriptionResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for updateSubscriptionResult
     * @uses UpdateSubscriptionResult::setCommonResponse()
     * @uses UpdateSubscriptionResult::setPaymentResponse()
     * @uses UpdateSubscriptionResult::setOrderResponse()
     * @uses UpdateSubscriptionResult::setCardResponse()
     * @uses UpdateSubscriptionResult::setAuthorizationResponse()
     * @uses UpdateSubscriptionResult::setCaptureResponse()
     * @uses UpdateSubscriptionResult::setCustomerResponse()
     * @uses UpdateSubscriptionResult::setMarkResponse()
     * @uses UpdateSubscriptionResult::setThreeDSResponse()
     * @uses UpdateSubscriptionResult::setExtraResponse()
     * @uses UpdateSubscriptionResult::setSubscriptionResponse()
     * @uses UpdateSubscriptionResult::setFraudManagementResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\UpdateSubscriptionResult
     */

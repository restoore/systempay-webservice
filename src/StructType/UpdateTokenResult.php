...
/**
 * This class stands for updateTokenResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class UpdateTokenResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for updateTokenResult
     * @uses UpdateTokenResult::setCommonResponse()
     * @uses UpdateTokenResult::setPaymentResponse()
     * @uses UpdateTokenResult::setOrderResponse()
     * @uses UpdateTokenResult::setCardResponse()
     * @uses UpdateTokenResult::setAuthorizationResponse()
     * @uses UpdateTokenResult::setCaptureResponse()
     * @uses UpdateTokenResult::setCustomerResponse()
     * @uses UpdateTokenResult::setMarkResponse()
     * @uses UpdateTokenResult::setThreeDSResponse()
     * @uses UpdateTokenResult::setExtraResponse()
     * @uses UpdateTokenResult::setSubscriptionResponse()
     * @uses UpdateTokenResult::setFraudManagementResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\UpdateTokenResult
     */

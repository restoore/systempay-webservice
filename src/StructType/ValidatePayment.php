...
/**
 * This class stands for validatePayment StructType
 * Meta informations extracted from the WSDL
 * - type: tns:validatePayment
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class ValidatePayment extends AbstractStructBase
{
    /**
     * The commonRequest
     * Meta informations extracted from the WSDL
    ...
    public $queryRequest;
    /**
     * Constructor method for validatePayment
     * @uses ValidatePayment::setCommonRequest()
     * @uses ValidatePayment::setQueryRequest()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonRequest $commonRequest
     * @return \Restoore\SystempayWebservice\StructType\ValidatePayment
     */

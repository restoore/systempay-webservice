...
/**
 * This class stands for validatePaymentResult StructType
 * @subpackage Structs
 * @author restoore <github.com/restoore>
 * @date 2016-02-22
 * @version 1.0.0
 */
class ValidatePaymentResult extends WsResponse
{
    /**
     * The commonResponse
    ...
    /**
     * Constructor method for validatePaymentResult
     * @uses ValidatePaymentResult::setCommonResponse()
     ...
     * @param \Restoore\SystempayWebservice\StructType\CommonResponse $commonResponse
     * @return \Restoore\SystempayWebservice\StructType\ValidatePaymentResult
     */
